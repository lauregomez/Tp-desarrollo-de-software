...
async function seedCourts(clubs: { id: number; name: string }[]) {
  const courts = [
    { club: 'Club Velocidad y Resistencia', name: 'Velocidad y Resistencia', address: 'Urquiza 2737, Rosario', capacity: 400 },
    { club: 'Club Atlético Rosario Central', name: 'Rosario Central', address: 'Mitre 853, Rosario', capacity: 800 },
    { club: "Club Atlético Newell's Old Boys", name: "Newell's", address: 'Parque Independencia s/n, Rosario', capacity: 800 },
    { club: 'Club Atlético Provincial', name: 'Provincial', address: 'Bv. 27 de Febrero 2672, Rosario', capacity: 500 },
    { club: 'Club Atlético Horizonte', name: 'Horizonte', address: 'Suipacha 1363, Rosario', capacity: 250 },
    { club: 'Unión Sionista Argentina de Rosario', name: 'Unión Sionista', address: 'Salta 2555, Rosario', capacity: 300 },
    { club: 'Náutico Sportivo Avellaneda', name: 'Náutico Avellaneda', address: 'Pedro Tuella 952, Rosario', capacity: 400 },
    { club: 'Club Social Argentino Sirio', name: 'Sirio', address: 'Italia 965, Rosario', capacity: 300 },
    { club: 'Sociedad Tiro Suizo Rosario', name: 'Tiro Suizo', address: 'Cortada Raffo 5120, Rosario', capacity: 250 },
    { club: 'Club Atlético Banco Nación', name: 'Banco Nación', address: 'Bv. Rondeau 2932, Rosario', capacity: 300 },
    { club: 'Remeros Alberdi', name: 'Remeros Alberdi', address: 'Av. Carrasco 2055, Rosario', capacity: 250 },
    { club: 'Colegio Marista Rosario', name: 'Colegio Marista', address: 'Bv. Oroño 770, Rosario', capacity: 200 },
    { club: 'Rosario Rowing Club', name: 'Rosario Rowing', address: 'Av. Colombres 1798, Rosario', capacity: 250 },
    { club: 'Club Atlético Sagrado Corazón', name: 'Sagrado Corazón', address: 'Dorrego 1260, Rosario', capacity: 250 },
    { club: 'Jockey Club Rosario', name: 'Jockey Club', address: 'Córdoba y Wilde, Rosario', capacity: 300 },
    { club: 'Club Residentes Parquefield', name: 'Parquefield', address: 'Del Blanqui 2120, Rosario', capacity: 200 },
    { club: 'Club de Regatas Rosario', name: 'Regatas', address: 'Juan B. Cordiviola 1268, Rosario', capacity: 350 },
    { club: 'Club Universitario', name: 'Universitario', address: 'Av. del Huerto 1051, Rosario', capacity: 300 },
    { club: 'Universidad Nacional de Rosario', name: 'UNR', address: 'Moreno 460, Rosario', capacity: 400 },
    { club: 'Club Social y Deportivo Unión Americana', name: 'Unión Americana', address: 'Brassey 7801 (esq. Colombres), Rosario', capacity: 250 },
    { club: 'Club Atlético María Madre de La Lata', name: 'La Lata', address: 'Presidente Quintana 1600, Rosario', capacity: 150 },
    { club: 'Club Atlético Talleres Rosario Puerto Belgrano', name: 'Talleres', address: 'Juan D. Perón 1790, Villa Gobernador Gálvez', capacity: 250 },
    { club: 'Club Social y Deportivo Nueva Aurora', name: 'Nueva Aurora', address: 'Suipacha 2175, Rosario', capacity: 200 },
    { club: 'Club Atlético Libertad', name: 'Libertad', address: 'Felipe Moré 1150, Rosario', capacity: 250 },
    { club: 'Club Social y Deportivo Federal', name: 'Federal', address: 'Zeballos 4649, Rosario', capacity: 250 },
    { club: 'Club Deportivo Unión Central', name: 'Unión Central', address: 'Iguazú y Junín, Rosario', capacity: 200 },
    { club: 'Club Social y Deportivo Río Negro', name: 'Río Negro', address: 'Forest 6251, Rosario', capacity: 200 },
    { club: 'Club Deportivo y Social Lux', name: 'Lux', address: 'Pascual Rosas 403, Rosario', capacity: 250 },
    { club: 'Club Atlético Social Deportivo y Cultural 1º de Mayo', name: '1º de Mayo', address: 'Av. Kennedy y Gianneo, Rosario', capacity: 200 },
    { club: 'Club Teléfonos Rosario', name: 'Teléfonos', address: 'Buchanan 551, Rosario', capacity: 250 },
  ];
